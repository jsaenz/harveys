<?php
  ...
  $email_subject = "Custom DrySuit Order";
  ...
  $email_message .= '<tr><td>Suit Style: </td><td>'.strip_tags($_POST['Suit_Style']). "</td></tr>";
  $email_message .= "<tr style='background: #eee;'><td>Neck: </td><td>".strip_tags($_POST['Neck']). "</td></tr>";
  $email_message .= "<tr><tr style='background: #eee;'><td>Wrist: </td><td>".strip_tags($_POST['Wrist']). "</td></tr>";
  $email_message .= '<td>Chest at Largest Point: </td><td>'.strip_tags($_POST['Chest_at_Largest_Point']). "</td></tr>";
  $email_message .= '<td>Waist: </td><td>'.strip_tags($_POST['Waist']). "</td></tr>";
  ...
  $email_message .= "<tr style='background: #eee;'><td>Crotch to Floor</td><td>".strip_tags($_POST['Crotch_to_Floor']). "</td></tr>";
  ...
  $email_message .= "<tr style='background: #eee;'><td>Hood Size </td><td>".strip_tags($_POST['Hood']). "</td></tr>";
