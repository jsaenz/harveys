...
<form method="post" action="send_form_email.php" onsubmit="return WetSuit_form_Validator(this)" language="JavaScript" name="WetSuit_form">
    <h2><span class="muted">Wet Suit Custom Order Form</span></h2>
    <p>
    ...
    <img class="featurette-image" src="img/wet_suit_measurement.jpg">
      ...
      <tr>
        <td valign="top" width="300">
          <div id="sh2" style="display:none;">
            ...
            <img class="featurette-image" src="img/wet_suit_measurement_female.jpg">
            <div class="span4">
...
<form method="post" action="send_dry_form_email.php" onsubmit="return DrySuit_form_Validator(this)" language="JavaScript" name="DrySuit_form">
    <h2><span class="muted">Dry Suit Custom Order Form</span></h2>
    <p>
    <p>First Name: &nbsp;<input class="input-medium" type="text" name="First_Name" size="30" maxlength="30"><br>
    Last Name: &nbsp;<input class="input-medium" type="text" name="Last_Name" size="30" maxlength="30"><br>
    Email: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="input-medium" type="text" name="Email" size="30" maxlength="30"><br>
    ...
    <img class="featurette-image" src="img/dry_suit_measurement.png">
    <table class="table-bordered table-condensed" id="table1" width="700" align="center" style="background-color:#fff;">
      <tr>
        <td width="300" height="600">
          <p align="center"><b>Customer Measurements</b></p>
          <div class="span4">
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Suit_Style" size="10" maxlength="10">&nbsp;Suit Style</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Neck" size="10" maxlength="10">&nbsp;Neck</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Wrist" size="10" maxlength="10">&nbsp;Wrist</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Chest_at_Largest_Point" size="10" maxlength="10">&nbsp;Chest at Largest Point</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Waist" size="10" maxlength="10">&nbsp;Waist at Navel</p>
          ...
          <div class="span4">
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Crotch_to_Floor" size="10" maxlength="10">&nbsp;Crotch to Floor</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Shoulder_Seam_to_Crotch" size="10" maxlength="10">&nbsp;Shoulder Seam to Crotch</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Wrist_to_Underarm" size="10" maxlength="10">&nbsp;Wrist to Underarm</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Shoe" size="10">&nbsp;Shoe Size</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Hood" size="10">&nbsp;Hood Size</p>
            <p align="left">&nbsp;<input class="input-mini" type="text" name="Glove" size="10">&nbsp;Glove Size</p>
          </div><!-- /.span4 -->
        </td>
      </tr>
...
<script Language="JavaScript" Type="text/javascript">
  function DrySuit_form_Validator(theForm)
  {
    ...
    if (theForm.Suit_Style.value == "")
    {
      alert("Please enter a value for the \"Suit Style\" field.");
      theForm.Suit_Style.focus();
      return (false);
    }

    if (theForm.Suit_Style.value.length > 10)
    {
      alert("Please enter at most 10 characters in the \"Suit Style\" field.");
      theForm.Suit_Style.focus();
      return (false);
    }
    ...
    if (theForm.Crotch_to_Floor.value == "")
    {
      alert("Please enter a value for the \"Crotch to Floor\" field.");
      theForm.Crotch_to_Floor.focus();
      return (false);
    }

    if (theForm.Crotch_to_Floor.value.length > 10)
    {
      alert("Please enter at most 10 characters in the \"Crotch to Floor\" field.");
      theForm.Crotch_to_Floor.focus();
      return (false);
    }
    ...
    if (theForm.Shoe.value == "")
    {
      alert("Please enter a value for the \"Shoe\" field.");
      theForm.Shoe.focus();
      return (false);
    }

    if (theForm.Shoe.value.length > 10)
    {
      alert("Please enter at most 10 characters in the \"Shoe\" field.");
      theForm.Shoe.focus();
      return (false);
    }
    if (theForm.Hood.value == "")
    {
      alert("Please enter a value for the \"Hood\" field.");
      theForm.Hood.focus();
      return (false);
    }

    if (theForm.Hood.value.length > 10)
    {
      alert("Please enter at most 10 characters in the \"Hood\" field.");
      theForm.Hood.focus();
      return (false);
    }
    if (theForm.Glove.value == "")
    {
      alert("Please enter a value for the \"Glove\" field.");
      theForm.Glove.focus();
      return (false);
    }

    if (theForm.Glove.value.length > 10)
    {
      alert("Please enter at most 10 characters in the \"Glove\" field.");
      theForm.Glove.focus();
      return (false);
    }
  }
